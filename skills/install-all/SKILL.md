...
description: 一次安裝並執行全部七個懶人包技能（環境建置、Gemini Notebook、GitHub、Obsidian、Firebase、生圖、Cloudflare）。說「全部安裝」「裝完所有懶人包」「一次安裝全部」時載入。
---
...
4. **逐項確認是否要執行 00–06**。已安裝且驗證正常的外部工具可以跳過執行，
